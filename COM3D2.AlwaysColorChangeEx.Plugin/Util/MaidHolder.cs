        ...
        public void SetDelNodes(Maid maid, Dictionary<string, bool> dDelNodes, bool bApply) {
            ...
            foreach (var entry in dDelNodes) {
                ...
                if (entry.Value) { // 
                    ...
                    {
                        var slot = maid.body0.goSlot[Index];
...
//            }
            ...
            foreach (var pair in maskDic) {
                ...
                if (!maskInfo.value) {
                    ...
                    for (int Index = 0; Index < maid.body0.goSlot.Count; Index++)
                    {
                        var tBodySkin = maid.body0.goSlot[Index];
        ...
        public void SetAllVisible() {
            ...
            for (int Index = 0; Index < CurrentMaid.body0.goSlot.Count; Index++)
            {
                var tBodySkin = CurrentMaid.body0.goSlot[Index];
